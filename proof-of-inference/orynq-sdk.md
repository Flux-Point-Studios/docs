...
**Orynq** is the umbrella platform for AI verification and attestation services, with **process-trace anchoring** as its core capability. (Orynq supersedes the earlier Proof-of-Inference protocol — see the [Orynq overview](README.md).)
