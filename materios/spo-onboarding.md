...
| Materios chain spec | Connecting your node | `https://materios.fluxpointstudios.com/chain-spec-v3-raw.json` |
...
/path/to/partner-chains-node-v1.8.0-x86_64-linux registration-status \
    --chain /path/to/materios-chain-spec-v3-raw.json \
...
- `materios-node` via `ghcr.io/flux-point-studios/materios-node:v3`
- chain spec from `https://materios.fluxpointstudios.com/chain-spec-v3-raw.json`
...
**Partner-chain genesis hash:** `0x37a6bbe4be1a81995d9edb706cea9a7daa16f4777c85aa2fc7db107cc486dcde`
